...
const UpdatePlace = () => {
  ...
  let changeHandler = (event) => {
    ...
    let fetchApi = async()=>{
  let res = await axios.get("https://travel-api-v5co.onrender.com/getPlace/"+id)
 setForm(res.data);
// console.log(res);
 }
...
useEffect(()=>{
  ...
  let handlerForm = async (e) => {
    e.preventDefault();
    let res = await axios.put("https://travel-api-v5co.onrender.com/updatePlace/"+id,form);
    if(res.data == "updated"){
    ...
    <>
         ...
         <div className=" min-h-[70vh]">
           ...
           <form onSubmit={handlerForm}>
             <h1 className="text-2xl text-amber-500 font-bold mb-4">Update Place</h1>
